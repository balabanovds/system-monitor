...
proto.metric.ParsersInfoResponse = function(opt_data) {
    jspb.Message.initialize(
        ...
        0,
        -1,
        proto.metric.ParsersInfoResponse.repeatedFields_,
        null,
    );
};
...
if (goog.DEBUG && !COMPILED) {
     ...
     * @override
     */
    proto.metric.ParsersInfoResponse.displayName =
...
proto.metric.ParserInfo = function(opt_data) {
    jspb.Message.initialize(
        ...
        0,
        -1,
        proto.metric.ParserInfo.repeatedFields_,
        null,
    );
};
...
proto.metric.Metric.prototype.getType = function() {
    return /** @type {!proto.metric.MetricType} */ (jspb.Message.getFieldWithDefault(
        this,
        2,
        0,
    ));
...
if (jspb.Message.GENERATE_TO_OBJECT) {
     ...
     * @return {!Object}
     */
    proto.metric.ParsersInfoResponse.prototype.toObject = function(
        opt_includeInstance,
    ) {
        return proto.metric.ParsersInfoResponse.toObject(
            opt_includeInstance,
            this,
        );
    };
        ...
        var f,
            obj = {
                listList: jspb.Message.toObjectList(
                    msg.getListList(),
                    proto.metric.ParserInfo.toObject,
                    includeInstance,
                ),
            };
...
proto.metric.ParsersInfoResponse.deserializeBinary = function(bytes) {
    ...
    return proto.metric.ParsersInfoResponse.deserializeBinaryFromReader(
        msg,
        reader,
    );
};
 ...
 * @return {!proto.metric.ParsersInfoResponse}
 */
proto.metric.ParsersInfoResponse.deserializeBinaryFromReader = function(
    msg,
    reader,
) {
    while (reader.nextField()) {
        ...
        switch (field) {
            case 1:
                ...
                reader.readMessage(
                    value,
                    proto.metric.ParserInfo.deserializeBinaryFromReader,
                );
                msg.addList(value);
                break;
            default:
 ...
 * @suppress {unusedLocalVariables} f is only used for nested messages
 */
proto.metric.ParsersInfoResponse.serializeBinaryToWriter = function(
    message,
    writer,
) {
    var f = undefined;
...
proto.metric.ParsersInfoResponse.prototype.getListList = function() {
    return /** @type{!Array<!proto.metric.ParserInfo>} */ (jspb.Message.getRepeatedWrapperField(
        this,
        proto.metric.ParserInfo,
        1,
    ));
};
 ...
 */
proto.metric.ParsersInfoResponse.prototype.addList = function(
    opt_value,
    opt_index,
) {
...
proto.metric.ParserInfo.prototype.getType = function() {
    return /** @type {!proto.metric.ParserType} */ (jspb.Message.getFieldWithDefault(
        this,
        1,
        0,
    ));
...
proto.metric.ParserInfo.prototype.getMetrictypesList = function() {
    return /** @type {!Array<!proto.metric.MetricType>} */ (jspb.Message.getRepeatedField(
        this,
        2,
    ));
};
